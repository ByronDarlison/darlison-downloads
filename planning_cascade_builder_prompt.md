...
- partial: true is governed only for: [['client-a', '3hag'], ['client-a', '1hag'], ['client-a', 'qhag'], ['client-b', '3hag'], ['client-b', '1hag'], ['client-b', 'qhag']]
...
- **partial_governed**: partial: true is only allowed for the six Client A/Client B migration cells (PARTIAL_GOVERNED_CELLS). A new partial cell requires a Byron ruling, not just a flag.
