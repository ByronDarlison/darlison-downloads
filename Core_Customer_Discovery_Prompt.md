...
4. **Test reachability.** Can you walk into a room full of this person? Where is that room? (3 minutes)
5. **Write the statement.** One sentence that proves you understand your Core Customer, tested against five questions. (2 minutes)
...
If the business is brand new and they do not have customers yet, reframe each question: draw on past work experience, consulting projects, the customers they observed in previous roles, the problem they saw that made them want to start this business.
...
**What drives them.** This is where Donald Miller's StoryBrand framework applies. Ask three questions in sequence:
...
Note that the Market Map, which is the next exercise in this series, will test reachability further. But if the founder cannot name a single room right now, that is a signal worth surfacing.
...
Then run five tests. Present each one and ask for a yes or no:
...
4. **Reachability.** Where they congregate, whether they refer each other, the named room of 50+, and the most efficient path to reach them.
5. **Core Customer Statement.** The one sentence, plus the five test results.
6. **What comes next.** Include all of the following:
   ...
   - Read *Building a StoryBrand* by Donald Miller and create a BrandScript with your Core Customer as the character. The profile tells you who. The BrandScript tells you how to communicate with them.
