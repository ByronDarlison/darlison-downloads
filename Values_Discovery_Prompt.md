...
The base format is non-negotiable: every hiring question opens with the exact phrase "Tell me about a time" and contains the exact phrase "What happened?" as the FIRST follow-up question, before any optional sub-questions. Do not replace "What happened?" with a paraphrase like "What was it?", "What did you do?", or "What did you invest?". The literal string "What happened?" must appear in every hiring question. Optional sharpening sub-questions may extend the base AFTER "What happened?" if the founder wants to probe a specific dimension (e.g., "How did people react?", "What did you learn?", "What would you do differently?"). Sub-questions extend the base; they do not replace it. Worked example: `Tell me about a time you protected a client from a risk they could not see. What happened? How did the client react?` PASSES. `Tell me about a time you protected a client from a risk they could not see. What was the risk? How did the client react?` FAILS because it skipped "What happened?".
